    ...
    <div className="container mx-auto p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {collectiblesList.map((collectible) => (
          <div key={collectible.id} onClick={() => router.push(`/collectibles/${collectible.id}`)} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
            <div className="relative h-48 w-full">
              <Image src={collectible.image} alt={collectible.title} fill className="object-cover" />
            </div>
            <div className="p-4">
